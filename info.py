...
auth_channel = environ.get('AUTH_CHANNEL', '-1001811608554') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001870015374')).split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Sankar")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'faxfiles') # owner username without @
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/SK_MoviesOffl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'SK_MoviesOffl') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://royal-king-3406.skmoviesofficial.workers.dev/")
